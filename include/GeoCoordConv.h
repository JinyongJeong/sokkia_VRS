...
protected:
	...
	// System Factor List 
    double m_arScaleFactor[TOTAL_GEO_SYSTEM];
    double m_arLonCenter[TOTAL_GEO_SYSTEM];
    double m_arLatCenter[TOTAL_GEO_SYSTEM];
    double m_arFalseNorthing[TOTAL_GEO_SYSTEM];
    double m_arFalseEasting[TOTAL_GEO_SYSTEM];
