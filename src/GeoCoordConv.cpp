							 ...
							 GeoEllips eDstEllips, GeoSystem eDstSystem)
{
    ...
    m_arScaleFactor[ITRF] = 0.9996;
    m_arLonCenter[ITRF] = D2R(127.5);
    m_arLatCenter[ITRF] = D2R(38.);
    m_arFalseNorthing[ITRF] = 2000000.0;
    m_arFalseEasting[ITRF]  = 1000000.0;

    m_arScaleFactor[kTmMidNew] = 1;
    m_arLonCenter[kTmMidNew] = D2R(127.);
    m_arLatCenter[kTmMidNew] = D2R(38.);
    m_arFalseNorthing[kTmMidNew] = 600000.0;
    m_arFalseEasting[kTmMidNew] = 200000.0;
}

///////////////////////////////////////////////
// Set Internal Values
void CGeoCoordConv::SetSrcType(GeoEllips eEllips, GeoSystem eSystem)
{
...
// Set Internal Values
void CGeoCoordConv::SetDstType(GeoEllips eEllips, GeoSystem eSystem)
{
